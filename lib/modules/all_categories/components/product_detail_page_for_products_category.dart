...
class ProductsPageDetailsCategoryHomePage extends StatefulWidget {
  final GetAllProductsFromCategoryModel getAllProductsFromCategoryModel;

  const ProductsPageDetailsCategoryHomePage(
      {Key? key, required this.getAllProductsFromCategoryModel})
      : super(key: key);

  @override
  State<ProductsPageDetailsCategoryHomePage> createState() =>
      _ProductsPageDetailsCategoryHomePageState(
          getAllProductsFromCategoryModel: getAllProductsFromCategoryModel);
}

class _ProductsPageDetailsCategoryHomePageState
    extends State<ProductsPageDetailsCategoryHomePage> {
  final GetAllProductsFromCategoryModel getAllProductsFromCategoryModel;
  late LikeBloc likeBloc;

  _ProductsPageDetailsCategoryHomePageState({required this.getAllProductsFromCategoryModel});
      ...
      child: BlocConsumer<LikeBloc, LikeState>(
        listener: (context, state) {
          if (state is LikeSuccess) {
            ...
            SharedPref.saveData(
                key: 'like', value: widget.getAllProductsFromCategoryModel.product!.id!);
            SharedPref.saveData(
                key: '${widget.getAllProductsFromCategoryModel.product!.id!}', value: like);
                ...
                children: [
                        ...
                        child: IconButton(
                          ...
                          onPressed: () {
                            if (SharedPref.getData(key: 'like') ==
                                widget.getAllProductsFromCategoryModel.product!.id!) {
                              like = SharedPref.getData(
                                  key:
                                  '${widget.getAllProductsFromCategoryModel.product!.id!}');
                            }
                            print(
                                'iiiiiiiiiiiiid=${widget.getAllProductsFromCategoryModel.product!.id!}');
                            if (like == false) {
                              likeBloc.like(
                                  id_product:
                                  widget.getAllProductsFromCategoryModel.product!.id!);
                  ...
                  Flexible(
                    ...
                    child: Container(
                      ...
                      height: 100,
                      child: Image.network(
                        ('$baseUrl1/products/${widget.getAllProductsFromCategoryModel.product!.imgUrl}'),
                        scale: 1,
                        width: double.infinity,
                      ),
                    ),
                  ...
                  Center(
                    child: Text('${widget.getAllProductsFromCategoryModel.product!.price}',
                        style: TextStyle(
                            fontFamily: 'Varela',
                            fontSize: 22.0,
                  ...
                  Center(
                    child: Text(widget.getAllProductsFromCategoryModel.product!.name!,
                        style: TextStyle(
                            ...
                            children:  [
                              ...
                              Row(children: [
                                ...
                                Padding(
                                  ...
                                  child: Text('${getAllProductsFromCategoryModel.product!.description!}'),
                                ),
                              ],),
                              Divider(
                                height: 40,
                              ...
                              Row(children: [
                                ...
                                Padding(
                                  padding: const EdgeInsets.only(left: 50),
                                  child: Text('${getAllProductsFromCategoryModel.product!.quantity!}'),
                                ),
                              ],),
                              Divider(
                                height: 40,
                              ...
                              Row(children: [
                                ...
                                Padding(
                                  padding: const EdgeInsets.only(left: 50),
                                  child: Text('${getAllProductsFromCategoryModel.product!.views!}'),
                                ),
                              ],),
                              Divider(
                                height: 40,
                              ...
                              Row(children: [
                                ...
                                Padding(
                                  padding: const EdgeInsets.only(left: 50),
                                  child: Text('${getAllProductsFromCategoryModel.product!.expDate!}'),
                                ),
                              ],),
                              Divider(
                                height: 40,
                              ...
                              Row(children: [
                                ...
                                Padding(
                                  padding: const EdgeInsets.only(left: 50),
                                  child: Text('${getAllProductsFromCategoryModel.product!.createdAt!}'),
                                ),
                              ],),
                              Divider(
                                height: 40,
                              ...
                              Row(children: [
                                ...
                                Padding(
                                  padding: const EdgeInsets.only(left: 50),
                                  child: Text('${getAllProductsFromCategoryModel.product!.updatedAt!}'),
                                ),
                              ],),
                            ],
                          ),
